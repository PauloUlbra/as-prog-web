...
<head>
    ...
    <title>AS - Programacao Web</title>
    <!-- Fonts -->
        ...
        <div class='flex flex-wrap justify-center px-10 py-3 relative'>
            <div id="collapseMenu"
                ...
                class='lg:flex lg:gap-x-10 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-2/3 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
                    <li class='max-lg:border-b max-lg:px-3 max-lg:py-3'><a href={{ url('artifacts') }}
                        class='hover:text-[#007bff] text-[#007bff] font-semibold block text-[15px]'>List Artifact</a></li>
                    ...
                    class='absolute top-5 max-lg:top-8 left-0 z-50 block space-y-2 shadow-lg bg-white max-h-0 overflow-hidden min-w-[250px] group-hover:opacity-100 group-hover:max-h-[700px] px-6 group-hover:pb-4 group-hover:pt-6 transition-all duration-500'>
                        <li class='border-b py-3'>
                            <a href={{ url('artifacts/create') }}
                            class='hover:text-[#007bff] hover:fill-[#007bff] text-gray-600 font-semibold text-[15px] block'>
                            Artifact
                            </a>
                        </li>
                        <li class='border-b py-3'>
                            <a href={{ url('expeditions/create') }}
                            class='hover:text-[#007bff] hover:fill-[#007bff] text-gray-600 font-semibold text-[15px] block'>
                            Expedition
                            </a>
                        </li>
                        <li class='border-b py-3'>
                            <a href={{ url('explorers/create') }}
                            class='hover:text-[#007bff] hover:fill-[#007bff] text-gray-600 font-semibold text-[15px] block'>
                            Explorer
                            </a>
                        </li>
                        <li class='border-b py-3'>
                            <a href={{ url('guides/create') }}
                            class='hover:text-[#007bff] hover:fill-[#007bff] text-gray-600 font-semibold text-[15px] block'>
                            Guide
                            </a>
                        </li>
                ...
                <li class='max-lg:border-b max-lg:px-3 max-lg:py-3'><a href= {{ url('expeditions') }}
                    class='hover:text-[#007bff] text-gray-600 font-semibold text-[15px] block'>List Expeditions</a>
                </li>
                <li class='max-lg:border-b max-lg:px-3 max-lg:py-3'><a href= {{ url('explorers') }}
                    class='hover:text-[#007bff] text-gray-600 font-semibold text-[15px] block'>List Explorers</a>
                </li>
                <li class='max-lg:border-b max-lg:px-3 max-lg:py-3'><a href= {{ url('guides') }}
                    class='hover:text-[#007bff] text-gray-600 font-semibold text-[15px] block'>List Guides</a>
                </li>
                </ul>
            </div>
